...
public class ChangedFacilityIdentifiersServiceImpl implements ChangedIdentifiersService {
  ...
  @UnitOfWork(CMS)
  protected ChangedFacilitiesIdentifiers getCwsCmsResumingInitialLoadIdentifiers(
      LocalDateTime timeStampAfter) {
  ...
  @UnitOfWork(CMS)
  protected ChangedFacilitiesIdentifiers getCwsCmsIncrementalLoadIdentifiers(
  ...
  @UnitOfWork(LIS)
  protected ChangedFacilitiesIdentifiers getLisIncrementalLoadIdentifiers(
      LocalDateTime timestampAfter) {
    ChangedFacilitiesIdentifiers changedEntityIdentifiers = new ChangedFacilitiesIdentifiers(
        DataSourceName.LIS);
  ...
  private Stream<ChangedEntityIdentifier> concat(ChangedFacilitiesIdentifiers cwscmsIdentifiers,
    ...
    return Stream.concat(cwscmsIdentifiers.newStream(), lisIdentifiers.newStream())
