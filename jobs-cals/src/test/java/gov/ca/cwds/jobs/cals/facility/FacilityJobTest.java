...
public class FacilityJobTest {
  ...
  private static FacilityJobConfiguration getFacilityJobConfiguration() {
    FacilityJobConfiguration facilityJobConfiguration =
        FacilityJobConfiguration
            .getJobsConfiguration(FacilityJobConfiguration.class, getConfigFilePath());
  ...
  private static String getConfigFilePath() {
    return Paths.get("src", "test", "resources", "cals", "facility", "test-facility-job.yaml")
