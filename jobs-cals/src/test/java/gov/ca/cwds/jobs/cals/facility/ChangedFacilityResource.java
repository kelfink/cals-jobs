...
public class ChangedFacilityResource {
  ...
  public CollectionDTO<ChangedFacilityDTO> incrementalLoad(
    ...
    Stream<ChangedEntityIdentifier> identifiers = changedFacilityIdentifiersService
        .getIdentifiersForIncrementalLoad(dateAfter);
    List<ChangedFacilityDTO> changedFacilityDTOList = identifiers
        .map(changedFacilityService::loadEntity).collect(Collectors.toList());
