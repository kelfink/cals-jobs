...
public class TestDataAccessModule extends AbstractModule {
  ...
  private final HibernateBundle<TestCalsJobsConfiguration> fasHibernateBundle =
      new HibernateBundle<TestCalsJobsConfiguration>(FasDataAccessModule.fasEntityClasses,
          new SessionFactoryFactory()) {
        @Override
        public PooledDataSourceFactory getDataSourceFactory(
            TestCalsJobsConfiguration configuration) {
  ...
  private final HibernateBundle<TestCalsJobsConfiguration> cwsCmsRsHibernateBundle =
      new HibernateBundle<TestCalsJobsConfiguration>(CwsCmsRsDataAccessModule.cwsrsEntityClasses,
          new SessionFactoryFactory()) {
        @Override
        public PooledDataSourceFactory getDataSourceFactory(
            TestCalsJobsConfiguration configuration) {
  ...
  private final HibernateBundle<TestCalsJobsConfiguration> lisHibernateBundle =
      new HibernateBundle<TestCalsJobsConfiguration>(LisDataAccessModule.lisEntityClasses,
          new SessionFactoryFactory()) {
        @Override
        public PooledDataSourceFactory getDataSourceFactory(
            TestCalsJobsConfiguration configuration) {
  ...
  private final HibernateBundle<TestCalsJobsConfiguration> nsHibernateBundle =
      new HibernateBundle<TestCalsJobsConfiguration>(NsDataAccessModule.nsEntityClasses,
          new SessionFactoryFactory()) {
        @Override
        public PooledDataSourceFactory getDataSourceFactory(
            TestCalsJobsConfiguration configuration) {
