...
public class BatchPreprocessorTest {
    ...
    public void test_empty_dates_less_then_batch_number_and_some_not_empty_dates_more_then_batch_number() {
        ...
        ChangedEntityIdentifier changedEntityIdentifier1 = new ChangedEntityIdentifier("testId1", RecordChangeOperation.I,
                LocalDateTime.of(2015, 3, 4, 5, 6, 20));
        ChangedEntityIdentifier changedEntityIdentifier2 = new ChangedEntityIdentifier("testId2", RecordChangeOperation.I,
                LocalDateTime.of(2013, 5, 8, 1, 10, 25));
        ChangedEntityIdentifier changedEntityIdentifier3 = new ChangedEntityIdentifier("testId3", RecordChangeOperation.I,
                LocalDateTime.of(2017, 8, 5, 5, 6, 10));
        ChangedEntityIdentifier changedEntityIdentifier4 = new ChangedEntityIdentifier("testId4", RecordChangeOperation.I,
        ...
        assertEquals(batchSize, getIdentifiersCount(jobBatches.get(2), changedEntityIdentifier1, changedEntityIdentifier2, changedEntityIdentifier4));
    ...
    public void test_not_empty_dates_less_then_batch_number() {
        ...
        ChangedEntityIdentifier changedEntityIdentifier2 = new ChangedEntityIdentifier("testId2", RecordChangeOperation.I,
                LocalDateTime.of(2013, 5, 8, 1, 10, 25));
        Stream<ChangedEntityIdentifier> identifiers = Stream.of(changedEntityIdentifier1, changedEntityIdentifier2);
        List<JobBatch> jobBatches = jobBatchPreProcessor.buildJobBatches(identifiers);
        assertEquals(1, jobBatches.size());
        assertEquals(LocalDateTime.of(2015, 3, 4, 5, 6, 20),
                jobBatches.get(0).getTimestamp());
        assertEquals(2, jobBatches.get(0).getChangedEntityIdentifiers().size());
        assertEquals(2, getIdentifiersCount(jobBatches.get(0), changedEntityIdentifier1, changedEntityIdentifier2));
    }
    ...
    public void complexBatchPrepossessingTest() {
        ...
        ChangedEntityIdentifier changedEntityIdentifier3 = new ChangedEntityIdentifier("testId3", RecordChangeOperation.I,
                LocalDateTime.of(2017, 8, 5, 5, 6, 10));
        ChangedEntityIdentifier changedEntityIdentifier4_1 = new ChangedEntityIdentifier("testId41", RecordChangeOperation.I,
                TIMESTAMP_4);
        ChangedEntityIdentifier changedEntityIdentifier4_2 = new ChangedEntityIdentifier("testId42", RecordChangeOperation.I,
                TIMESTAMP_4);
        ChangedEntityIdentifier changedEntityIdentifier4_3 = new ChangedEntityIdentifier("testId43", RecordChangeOperation.I,
                TIMESTAMP_4);
        ChangedEntityIdentifier changedEntityIdentifier5 = new ChangedEntityIdentifier("testId5", RecordChangeOperation.I,
        ...
        assertEquals(batchSize, getIdentifiersCount(jobBatches.get(5), changedEntityIdentifier1, changedEntityIdentifier2));
        ...
        assertEquals(batchSize, getIdentifiersCount(jobBatches.get(6), changedEntityIdentifier3, changedEntityIdentifier5));
