...
RFL.IDENTIFIER AS REFERAL_ID,
RFL.REF_RCV_DT AS START_DATE,
RFL.REFCLSR_DT AS END_DATE,
RPT.FKREFERL_T AS RPTR_ID,
RPT.RPTR_FSTNM AS RPTR_FIRST_NM,
RPT.RPTR_LSTNM AS RPTR_LAST_NM,
STP.IDENTIFIER AS STAFF_ID,
STP.FIRST_NM AS WRKR_FIRST_NM,
STP.LAST_NM AS WRKR_LAST_NM,
CLP.IDENTIFIER AS PERP_ID,
CLP.COM_FST_NM AS PERP_FIRST_NM,
CLP.COM_LST_NM AS PERP_LAST_NM,
CLV.IDENTIFIER AS VICT_ID,
CLV.COM_FST_NM AS VICT_FIRST_NM,
CLV.COM_LST_NM AS VICT_LAST_NM,
RFL.GVR_ENTC,
ALG.ALG_DSPC,
ALG.ALG_TPC,
