...
@NamedNativeQueries({
    @NamedNativeQuery(name = "gov.ca.cwds.dao.cms.EsNsScreeningHistory.findBucketRange",
        query = "SELECT x.* FROM {h-schema}VW_SCREENING_HISTORY x "
    ...
    @NamedNativeQuery(name = "gov.ca.cwds.dao.cms.EsNsScreeningHistory.findAllUpdatedAfter",
        query = "SELECT x.* FROM {h-schema}VW_SCREENING_HISTORY x "
