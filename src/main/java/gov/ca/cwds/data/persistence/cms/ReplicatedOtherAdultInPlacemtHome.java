...
@NamedNativeQueries({
    @NamedNativeQuery(
        name = "gov.ca.cwds.data.persistence.cms.ReplicatedOtherAdultInPlacemtHome.findAllUpdatedAfter",
    ...
    @NamedNativeQuery(
        name = "gov.ca.cwds.data.persistence.cms.ReplicatedOtherAdultInPlacemtHome.findAllByBucket",
        query = "select z.IDENTIFIER, z.BIRTH_DT, z.END_DT, z.GENDER_CD, z.OTH_ADLTNM, "
            + "z.START_DT, z.LST_UPD_ID, z.LST_UPD_TS, z.FKPLC_HM_T, z.COMNT_DSC, "
            + "z.OTH_ADL_CD, z.IDENTFD_DT, z.RESOST_IND, z.PASSBC_CD "
