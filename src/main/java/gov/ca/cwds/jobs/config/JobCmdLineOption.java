...
public enum JobCmdLineOption {
   ...
   */
  INDEX_NAME(JobOptions.makeOpt("i", JobOptions.CMD_LINE_INDEX_NAME, "ElasticSearch index name", false, 1, String.class, ',')),

  /**
   * Last run time in format 'yyyy-MM-dd HH:mm:ss'
   */
  LAST_RUN_TIME(JobOptions.makeOpt("a", JobOptions.CMD_LINE_LAST_RUN_TIME, "last run time (yyyy-MM-dd HH:mm:ss)", false, 1, String.class, ',')),
