...
//@formatter:off
  public String getPrepLastChangeSQL() {
    return "INSERT INTO GT_ID (IDENTIFIER)"
     ...
     // + "AND CCL1.IBMSNAP_OPERATION IN ('I','U') "
        + "\nLEFT JOIN CLIENT_T CLC1 ON CLC1.IDENTIFIER = CCL1.FKCLIENT_T "
     // + "AND CLC1.IBMSNAP_OPERATION IN ('I','U') "
     ...
     // + "AND CCL2.IBMSNAP_OPERATION IN ('I','U') "
        + "\nLEFT JOIN CLIENT_T CLC2 ON CLC2.IDENTIFIER = CCL2.FKCLIENT_T "
     // + "AND CLC2.IBMSNAP_OPERATION IN ('I','U') "
     ...
     // + "AND CCL3.IBMSNAP_OPERATION IN ('I','U') "
     ...
     // + "AND CCL.IBMSNAP_OPERATION IN ('I','U') "
