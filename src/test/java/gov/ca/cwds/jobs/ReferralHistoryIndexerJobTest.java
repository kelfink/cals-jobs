...
public class ReferralHistoryIndexerJobTest {
  ...
  public void mustDeleteLimitedAccessRecords_Args__() throws Exception {
	...
	public void extractReferral_Args__ResultSet() throws Exception {
		...
		ReplicatedPersonReferralsDao clientDao = null;
		ElasticsearchDao esDao = null;
		String lastJobRunTimeFilename = null;
		ObjectMapper mapper = null;
		SessionFactory sessionFactory = null;
		ReferralHistoryIndexerJob target = new ReferralHistoryIndexerJob(clientDao, esDao, lastJobRunTimeFilename, mapper, sessionFactory);
		// given
		ResultSet rs = mock(ResultSet.class);
