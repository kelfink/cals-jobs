...
/**
 * This example reads Java class files, directories or JARs given as program arguments and dumps
 * information about the classes.
 */
public final class JacocoClassInfo implements ICoverageVisitor {
   ...
   */
  public JacocoClassInfo(final PrintStream out) {
    this.out = out;
  ...
  public static void main(final String[] args) throws IOException {
    new JacocoClassInfo(System.out).execute(args);
  }
