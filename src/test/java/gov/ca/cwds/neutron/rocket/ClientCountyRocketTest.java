...
import gov.ca.cwds.neutron.rocket.ClientCountyRocket.*;
...
public class ClientCountyRocketTest extends Goddard<ReplicatedClient, EsClientAddress> {
  ...
  public void main_Args__StringArray() throws Exception {
	...
	@Test
	public void processStatement_Args__Pair__Connection() throws Exception {
		// TODO auto-generated by JUnit Helper.
		ReplicatedClientDao dao = null;
		ElasticsearchDao esDao = null;
		String lastRunFile = null;
		ObjectMapper mapper = null;
		SessionFactory sessionFactory = null;
		FlightPlan flightPlan = null;
		ClientCountyRocket target = new ClientCountyRocket(dao, esDao, lastRunFile, mapper, sessionFactory, flightPlan);
		// given
		Pair<String, String> p = mock(Pair.class);
		Connection con = mock(Connection.class);
		// e.g. : given(mocked.called()).willReturn(1);
		// when
		target.processStatement(p, con);
		// then
		// e.g. : verify(mocked).called();
	}

	@Test
	public void processStatement_Args__Pair__Connection_T__SQLException() throws Exception {
		// TODO auto-generated by JUnit Helper.
		ReplicatedClientDao dao = null;
		ElasticsearchDao esDao = null;
		String lastRunFile = null;
