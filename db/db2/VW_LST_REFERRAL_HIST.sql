...
FROM CWSRSQ.REFR_CLT      RCT
JOIN CWSRSQ.CLIENT_T      CLT ON CLT.IDENTIFIER  = RCT.FKCLIENT_T
LEFT JOIN CWSRSQ.REFERL_T RFL ON RCT.FKREFERL_T  = RFL.IDENTIFIER
...
LEFT JOIN CWSRSQ.ALLGTN_T ALG ON ALG.FKREFERL_T  = RFL.IDENTIFIER
LEFT JOIN CWSRSQ.CLIENT_T CLP ON CLP.IDENTIFIER  = ALG.FKCLIENT_0
LEFT JOIN CWSRSQ.CLIENT_T CLV ON CLV.IDENTIFIER  = ALG.FKCLIENT_T
...
GRANT SELECT ON CWSRS1.VW_LST_REFERRAL_HIST TO CWDSNS1 ;
GRANT SELECT ON CWSRS1.VW_LST_REFERRAL_HIST TO CWDSNS3 ;
GRANT SELECT ON CWSRS1.VW_LST_REFERRAL_HIST TO CWDSNS4 ;
GRANT SELECT ON CWSRS1.VW_LST_REFERRAL_HIST TO CWDSNS5 ;
GRANT SELECT ON CWSRS1.VW_LST_REFERRAL_HIST TO CWDSNS6 ;
