...
CREATE TABLE MQT_CASE_HIST AS (
  ...
  CASE WHEN ((CLR.CLNTRELC BETWEEN 187 and 214) OR (CLR.CLNTRELC BETWEEN 245 and 254) OR (CLR.CLNTRELC BETWEEN 282 and 294) OR (CLR.CLNTRELC IN (272, 273, 5620, 6360, 6361))) THEN CLR.CLNTRELC END  AS PARENT_RELATIONSHIP,
  ...
  LEFT JOIN CLIENT_T CLP ON CLP.IDENTIFIER = CLR.FKCLIENT_T -- the client
  WHERE CLC.IBMSNAP_OPERATION IN ('I','U')
