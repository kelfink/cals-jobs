...
CREATE TABLE CWSRS1.VW_REFERRAL_HIST AS (
SELECT
...
SET INTEGRITY FOR CWSRS1.VW_REFERRAL_HIST MATERIALIZED QUERY IMMEDIATE UNCHECKED;
REFRESH TABLE CWSRS1.VW_REFERRAL_HIST;