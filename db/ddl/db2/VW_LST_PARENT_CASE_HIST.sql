DROP VIEW CWSRS1.VW_LST_PARENT_CASE_HIST;

CREATE VIEW CWSRS1.VW_LST_PARENT_CASE_HIST AS
SELECT DISTINCT v2.PARENT_ID AS PARENT_PERSON_ID,
	v1.CASE_ID,
	v1.START_DATE,
	v1.END_DATE,
	v1.COUNTY,
	...
	v1.LAST_CHG
FROM CWSRS1.VW_LST_CASE_HIST v1 
JOIN CWSRS1.VW_LST_CASE_HIST v2 ON v1.CASE_ID = v2.CASE_ID;
