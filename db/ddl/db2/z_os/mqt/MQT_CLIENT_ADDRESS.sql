...
DROP TABLE CWSRS1.MQT_CLIENT_ADDRESS;

CREATE TABLE CWSRS1.MQT_CLIENT_ADDRESS AS (
SELECT
...
SET INTEGRITY FOR CWSRS1.MQT_CLIENT_ADDRESS MATERIALIZED QUERY IMMEDIATE UNCHECKED;
REFRESH TABLE CWSRS1.MQT_CLIENT_ADDRESS ;
