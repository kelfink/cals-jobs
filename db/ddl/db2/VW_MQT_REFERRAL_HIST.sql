DROP VIEW CWSRSQ.VW_MQT_REFERRAL_HIST;

CREATE VIEW CWSRSQ.VW_MQT_REFERRAL_HIST (
	CLIENT_ID,
...
FROM CWSRSQ.GT_REFR_CLT 	 RC
JOIN CWSRSQ.REFERL_T         RFL  ON RC.FKREFERL_T  = RFL.FKREFERL_T
JOIN CWSRSQ.STFPERST         STP  ON RFL.FKSTFPERST = STP.IDENTIFIER
JOIN CWSRSQ.CMP_ALLGTN       ALG  ON ALG.FKREFERL_T = RFL.IDENTIFIER
JOIN CWSRSQ.CMP_CLIENT       CLV  ON CLV.IDENTIFIER = ALG.FKCLIENT_T
LEFT JOIN CWSRSQ.CMP_CLIENT  CLP  ON CLP.IDENTIFIER = ALG.FKCLIENT_0
