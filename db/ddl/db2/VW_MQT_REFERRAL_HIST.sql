...
SELECT 
	...
	CURRENT TIMESTAMP     AS RCT_IBMSNAP_LOGMARKER,
	'U'                   AS RCT_IBMSNAP_OPERATION,
	CURRENT TIMESTAMP     AS RFL_IBMSNAP_LOGMARKER,
	'U'                   AS RFL_IBMSNAP_OPERATION,
	CURRENT TIMESTAMP     AS STP_IBMSNAP_LOGMARKER,
	'U'                   AS STP_IBMSNAP_OPERATION,
	CURRENT TIMESTAMP     AS RPT_IBMSNAP_LOGMARKER,
	'U'                   AS RPT_IBMSNAP_OPERATION,
	CURRENT TIMESTAMP     AS ALG_IBMSNAP_LOGMARKER,
	'U'                   AS ALG_IBMSNAP_OPERATION,
	CURRENT TIMESTAMP     AS CLP_IBMSNAP_LOGMARKER,
	'U'                   AS CLP_IBMSNAP_OPERATION,
	CURRENT TIMESTAMP     AS CLV_IBMSNAP_LOGMARKER,
	'U'                   AS CLV_IBMSNAP_OPERATION,
	CURRENT TIMESTAMP     AS LAST_CHG
FROM CWSRS1.CMP_REFR_CLT 	  RC
JOIN CWSRSQ.REFERL_T          RFL  ON rc.FKREFERL_T  = RFL.FKREFERL_T
JOIN CWSRSQ.STFPERST          STP  ON RFL.FKSTFPERST = STP.IDENTIFIER
JOIN CWSRS1.VICTIM_ALLGTN     ALG  ON ALG.FKREFERL_T = RFL.IDENTIFIER
