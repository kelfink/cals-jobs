...
FROM CWSRS1.GT_REFR_CLT 	     RC
JOIN CWSRS1.REFERL_T             RFL  ON RFL.IDENTIFIER = RC.FKREFERL_T
JOIN CWSRS1.MQT_CMP_ALLGTN       ALG  ON ALG.FKREFERL_T = RFL.IDENTIFIER
JOIN CWSRS1.MQT_CMP_CLIENT       CLV  ON CLV.IDENTIFIER = ALG.FKCLIENT_T
LEFT JOIN CWSRS1.MQT_CMP_CLIENT  CLP  ON CLP.IDENTIFIER = ALG.FKCLIENT_0
