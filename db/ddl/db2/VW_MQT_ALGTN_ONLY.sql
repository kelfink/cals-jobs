...
JOIN CWSRS1.ALLGTN_T       ALG  ON ALG.FKREFERL_T = RC.FKREFERL_T
JOIN CWSRS1.CLIENT_T       CLV  ON CLV.IDENTIFIER = ALG.FKCLIENT_T
LEFT JOIN CWSRS1.CLIENT_T  CLP  ON CLP.IDENTIFIER = ALG.FKCLIENT_0
;
