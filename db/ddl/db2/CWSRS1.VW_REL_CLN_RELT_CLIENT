CREATE VIEW CWSRS1.VW_REL_CLN_RELT_CLIENT (
	THIS_LEGACY_TABLE, RELATED_LEGACY_TABLE, THIS_LEGACY_ID, THIS_LEGACY_LAST_UPDATED, THIS_FIRST_NAME, THIS_LAST_NAME, REL_CODE, RELATED_LEGACY_ID, RELATED_LEGACY_LAST_UPDATED, RELATED_FIRST_NAME, RELATED_LAST_NAME, LAST_CHG 
) AS 
SELECT
